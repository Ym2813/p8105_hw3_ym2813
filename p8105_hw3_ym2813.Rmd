...
Accelerometer data allows the inspection activity over the course of the day. Make a single-panel plot that 
...
From the plot we can see that the total activity time for each day differs significantly from one day to another. Moreover, even for the same day of the week, the activity time courses are very different week from week. This is abnormal, suggesting that there might be some mistake in the original data, especially the recording in Saturday, where the participants had as high as  607175 counts in week two and as low as 1440 in week 4 and 5. Therefore, we might have to go back to the original data and corect the data before further analysis. 